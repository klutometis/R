...
* TODO Embedded R
  ...
  #+BEGIN_SRC c :tangle Reval.c
    ...
    void to_real(SEXP arg, int i) {
      C_word *value = C_alloc(C_SIZEOF_FLONUM);
      C_save(C_flonum(&value, REAL(arg)[i]));
    }
              ...
              *(v++) = C_VECTOR_TYPE | length;
              ...
              for (i = 0; i < length; i++) {
                ...
                *(v++) = C_restore;
                ...
                /* *(v++) = to_real(Rvalue, i); */
                /* C_word *a = C_alloc(3); */
                /* k = C_closure(&a, 1, (C_word) to_real); */
                /* C_apply(4, C_SCHEME_UNDEFINED, k, (C_word) to_real, C_SCHEME_END_OF_LIST); */
              }
